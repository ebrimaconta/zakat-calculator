...
export const CalculatorForm = () => {
  ...
  return (
    <Div>
        ...
        />
              {formik.touched.goldSilver && formik.errors.goldSilver ? (
              <Error>{formik.errors.goldSilver}</Error>
              ) : null}
        ...
        />
         {formik.touched.cash && formik.errors.cash ? (
              <Error>{formik.errors.cash}</Error>
              ) : null}
        ...
        />
         {formik.touched.liabilities && formik.errors.liabilities ? (
              <Error>{formik.errors.liabilities}</Error>
              ) : null}
